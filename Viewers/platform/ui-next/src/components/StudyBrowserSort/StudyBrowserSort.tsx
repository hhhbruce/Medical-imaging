      ...
      <DropdownMenu>
        <Tooltip>
          <TooltipTrigger className="w-full overflow-hidden">
            <DropdownMenuTrigger className="border-inputfield-main focus:border-inputfield-focus flex h-[26px] w-full items-center justify-start overflow-hidden whitespace-nowrap rounded border bg-input/30 p-2 text-base text-foreground">
              {selectedSort.label}
            </DropdownMenuTrigger>
          </TooltipTrigger>
      ...
      <Tooltip>
        <TooltipTrigger>
          <button
            ...
            className="border-inputfield-main flex h-[26px] items-center justify-center rounded border bg-input/30"
          >
