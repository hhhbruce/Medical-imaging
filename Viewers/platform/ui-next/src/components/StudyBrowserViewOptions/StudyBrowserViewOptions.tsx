    ...
    <DropdownMenu>
      <Tooltip>
        <TooltipTrigger className="w-full w-[50%] overflow-hidden">
          <DropdownMenuTrigger className="border-inputfield-main focus:border-inputfield-focus flex h-[26px] w-full items-center justify-start rounded border bg-input/30 p-2 text-base text-foreground">
            {activeTab?.label}
          </DropdownMenuTrigger>
        </TooltipTrigger>
